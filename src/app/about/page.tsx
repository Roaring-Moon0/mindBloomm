...
const teamMembers: TeamMember[] = [
  ...
  { name: 'Kartik', role: 'Tester', avatar: '/assets/kartik.png', dataAiHint: 'person face', bio: 'I\'m Kartik sharma first-year student of BTECH Robotics and AI and in this project, I contribute as a tester, ensuring the website is reliable, user-friendly, and impactful.\n\nI\'m passionate about technology and its power to make a difference. Currently exploring web development, coding and participating in hackathons, I’m especially interested in creating solutions that support mental health and well-being.', email: 'kartiksharmaa2066@gmail.com', linkedin: 'https://www.linkedin.com/in/kartik-sharma-41b552336' },

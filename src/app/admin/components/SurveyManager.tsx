...
import { Loader2, PlusCircle, Trash2, Edit, AlertTriangle, FileText, ToggleLeft, ToggleRight } from 'lucide-react';
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row justify-between items-center">
        ...
        <Button onClick={handleAdd}><PlusCircle className="mr-2"/>Add Survey</Button>
      </CardHeader>
      <CardContent>
        {loading ? (
                ...
                <TableBody>
                    {surveys.map((survey) => (
                        <TableRow key={survey.id}>
                            ...
                            <TableCell><a href={survey.url} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline truncate">{survey.url}</a></TableCell>
